...
```mermaid
flowchart TD
    A[BigQuery: new-era-xdl<br/>sell_out, stock, master_material] --> B[Consulta SQL con CTEs<br/>sell_out / stock / combine / material_filtered]
    ...
    I1 --> J[Modelo de Forecasting<br/>de ventas por temporada]
```
